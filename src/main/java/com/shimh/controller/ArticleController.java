...
public class ArticleController {
    ...
    @LogAnnotation(module = "文章", operation = "获取所有文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "获取最热文章")//记录日志
    ...
    @GetMapping("/new")
    @FastJsonView(include = {@FastJsonFilter(clazz = Article.class, props = {"id", "title"})})
    @LogAnnotation(module = "文章", operation = "获取最新文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "根据id获取文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "根据id获取文章，添加阅读数")//记录日志
    ...
    @FastJsonView(
            exclude = {
                    ...
                    @FastJsonFilter(clazz = Tag.class, props = {"id", "avatar"})},
            include = {@FastJsonFilter(clazz = User.class, props = {"nickname"})})
    @LogAnnotation(module = "文章", operation = "根据标签获取文章")//记录日志
    ...
    @FastJsonView(
            exclude = {
                    ...
                    @FastJsonFilter(clazz = Tag.class, props = {"id", "avatar"})},
            include = {@FastJsonFilter(clazz = User.class, props = {"nickname"})})
    @LogAnnotation(module = "文章", operation = "根据分类获取文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "发布文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "修改文章")//记录日志
    ...
    @RequiresRoles(Base.ROLE_ADMIN)
    @LogAnnotation(module = "文章", operation = "删除文章")//记录日志
    ...
    @LogAnnotation(module = "文章", operation = "获取文章归档日期")//记录日志
